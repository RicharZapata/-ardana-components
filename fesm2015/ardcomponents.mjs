...
class InputFormComponent {
    ...
    ngAfterViewInit() {
        ...
        if (this.control.value !== '') {
            (_a = this.inputComponent) === null || _a === void 0 ? void 0 : _a.nativeElement.classList.add('filled');
        }
    }
    validate(control) {
    ...
    setFocus() {
        ...
        if (this.label !== null) {
            ...
            (_b = this.inputComponent) === null || _b === void 0 ? void 0 : _b.nativeElement.classList.add('focus');
            (_c = this.inputElement) === null || _c === void 0 ? void 0 : _c.nativeElement.addEventListener('focusout', (event) => {
                var _a;
                if (event.target.value == '')
                    (_a = this.inputComponent) === null || _a === void 0 ? void 0 : _a.nativeElement.classList.remove('focus');
            });
        }
    }
}
